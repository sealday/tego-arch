...
- [Microsoft Azure Well-Architected — Optimize scaling and partitioning](https://learn.microsoft.com/en-us/azure/well-architected/performance-efficiency/scale-partition)：用于规模单元、扩缩与分区事实摘要；不作为通用性能保证。
