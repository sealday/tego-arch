---
title: 单元架构与洗牌分片：限制故障半径
sidebar_label: 单元架构与洗牌分片
...
<details className="evidence-card">
  <summary>证据：当前AWS 指南、历史源码与失效来源</summary>
  ...
  - **证明边界：** 归档源码只解释公开历史思路，不是受维护依赖，也不能证明AWS 当前内部实现。
</details>
...
<details className="evidence-card">
  ...
  - **依赖结论：** 仓库已归档；这些源码是历史证据，不是当前AWS 实现或新依赖推荐。
</details>
...
- 旧[Prescriptive Guidance URL](https://docs.aws.amazon.com/prescriptive-guidance/latest/cell-based-architecture/welcome.html)于2026-07-22 返回HTTP 404；本文保留该状态，不从页面推导事实。
