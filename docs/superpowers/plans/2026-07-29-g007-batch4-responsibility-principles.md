...
- the two Microsoft records use `https://github.com/dotnet/docs/blob/main/LICENSE` as `license_evidence_url`, after verifying that both Learn pages expose their source in the official `dotnet/docs` repository, and name that repository-content CC-BY-4.0 boundary in `license_evidence_note`;
