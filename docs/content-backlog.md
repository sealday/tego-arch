...
- **当前发布基线：** 2026-07-24 完整 G005 内容基线已完成 11 个主题、56 篇内容文档与 394 个受治理来源。Batch 1 经 [`c68f134`](https://github.com/sealday/tego-arch/commit/c68f134) 和 [Pages run 30089504406](https://github.com/sealday/tego-arch/actions/runs/30089504406) 发布；Batch 2 经 [`eea2d76`](https://github.com/sealday/tego-arch/commit/eea2d76) 和 [Pages run 30095517683](https://github.com/sealday/tego-arch/actions/runs/30095517683) 发布；Batch 3 经 [`e196683`](https://github.com/sealday/tego-arch/commit/e196683) 和 [Pages run 30101647896](https://github.com/sealday/tego-arch/actions/runs/30101647896) 发布。2026-07-26 repository rename Stage A [`1f958b7`](https://github.com/sealday/tego-arch/commit/1f958b7b7671d43b55fcd819973ccc1de63e66f4) 由 [Pages run 30209699876](https://github.com/sealday/tego-arch/actions/runs/30209699876) 以 exact SHA、`completed`、`success` 完成 workflow 部署；规范仓库为 [`sealday/tego-arch`](https://github.com/sealday/tego-arch)，规范站点为 [`https://sealday.github.io/tego-arch/`](https://sealday.github.io/tego-arch/)。首页与代表路由、CSS/JS/roadmap image live smoke 均通过，首页显示 `5 / 20`、11、56、394、`G006` 且无旧 base。下方已完成主题行继续保留改名前的 commit、run 与 live-smoke 历史证据。
