...
- **当前发布基线：** 2026-07-24 完整 G005 内容基线已完成 11 个主题、56 篇内容文档与 394 个受治理来源。Batch 1 经 [`c68f134`](https://github.com/sealday/tego-arch/commit/c68f134) 和 [Pages run 30089504406](https://github.com/sealday/tego-arch/actions/runs/30089504406) 发布；Batch 2 经 [`eea2d76`](https://github.com/sealday/tego-arch/commit/eea2d76) 和 [Pages run 30095517683](https://github.com/sealday/tego-arch/actions/runs/30095517683) 发布；Batch 3 经 [`e196683`](https://github.com/sealday/tego-arch/commit/e196683) 和 [Pages run 30101647896](https://github.com/sealday/tego-arch/actions/runs/30101647896) 发布。当前规范站点入口为 [`https://sealday.github.io/tego-arch/`](https://sealday.github.io/tego-arch/)；下方已完成主题行继续保留改名前的 commit、run 与 live-smoke 历史证据。
