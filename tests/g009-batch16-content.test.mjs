...
export const ORIGINAL_SOURCE_CONTRACT = Object.freeze({id: ORIGINAL_SOURCE_ID, canonical_locator: '/img/diagrams/ddd-01-strategic-ddd-context-map.svg', transport_locator: '/img/diagrams/ddd-01-strategic-ddd-context-map.svg', source_kind: 'original-illustration', allowed_evidence_roles: ['illustration'], license: 'LicenseRef-Atlas-Original', copyright_policy: 'original-atlas', link_policy: null, usage_boundary: 'Original illustrative Context Map only; not evidence of a real company, production outcome, service topology or approved business boundaries.', license_evidence_note: 'Project-authored synchronized Draw.io/SVG teaching diagram created for DDD-01; original illustration only, with no third-party diagram, reference image, logo, brand visual, signature, watermark or copied composition. Draw.io/SVG synchronization and 800px light/dark artwork QA are complete; full-page screenshot evidence remains BLOCKED / NOT_ACCEPTED.', version: 'Original illustration created 2026-09-08; synchronized Draw.io/SVG and 800px light/dark artwork QA complete', expected_final_approval_note: 'Approved local original illustration; synchronized Draw.io/SVG creation and 800px light/dark artwork QA complete. Full-page screenshot evidence remains BLOCKED / NOT_ACCEPTED.'});
...
export function governanceFixture() {
  ...
  for (const expected of [...NEW_REMOTE_SOURCES, ORIGINAL_SOURCE_CONTRACT]) {
    const record = {...structuredClone(template), ...structuredClone(expected), title: expected.id, author_or_org: expected.id === ORIGINAL_SOURCE_ID ? 'Tego Arch maintainers' : expected.id, transport_locator: expected.canonical_locator, registered_at: '2026-09-08', checked_at: '2026-09-08', version: expected.version ?? 'fixture-only contract, not a live observation', license_family_id: expected.canonical_locator, license_scope: 'The named work only; third-party assets excluded.', license_evidence_url: expected.id === ORIGINAL_SOURCE_ID ? 'https://github.com/sealday/tego-arch/blob/main/' + SVG : expected.canonical_locator, license_evidence_note: expected.license_evidence_note ?? 'Fixture only; Task 2 must verify the real license evidence.', expected_final_transport_locator: expected.canonical_locator, expected_final_approved_at: '2026-09-08', expected_final_approval_note: expected.expected_final_approval_note ?? 'Fixture only; no live check claimed.'};
