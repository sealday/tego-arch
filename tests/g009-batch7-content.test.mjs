...
const RELATION_METADATA = {
  depends_on: ['STY-00', 'STY-05'],
    adjacent_topics: ['STY-04', 'STY-05', 'STY-07', 'STY-08', 'STY-09', 'STY-11', 'PR-11', 'MOD-08', 'STY-14'],
...
test('preserves the STY-06 closure under current DDD-01 complete projection', () => {
  assert.deepEqual({
