...
export const EXPECTED_STAGE_B = Object.freeze({completed: 65, documents: 109, sources: 573});
...
test('preserves exact STY-11 Stage B closure while the current projection publishes pending STY-12', () => {
  ...
  assert.deepEqual({published: manifestFuture?.published, status: manifestFuture?.status?.value}, {published: true, status: 'pending'});
