...
function assertCombinedProjection(statusValue = status, manifestValue = manifest, indexesValue = indexes, ledgerValue = publicLedger) {
  ...
  assert.deepEqual([topics.get('STY-09')?.published, topics.get('STY-09')?.status, styles.get('STY-09')?.published], [true, {scope: 'backlog-projection', value: 'pending', source: 'docs/content-backlog.md'}, true]);
