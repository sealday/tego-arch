...
function isHistoricalReviewArtifact(relative) {
  return relative.startsWith('docs/reviews/') &&
    ...
    relative !== 'docs/reviews/evidence/g009-batch16-stage-a-production-browser.json' &&
    relative !== 'docs/reviews/evidence/g009-batch16-stage-b-production-browser.json' &&
    ...
    relative !== 'docs/reviews/evidence/g009-batch15-stage-b-production-browser.json' &&
...
test('locks the exact pre-G010 review namespace against add edit and delete mutations', async () => {
  for (const currentPath of [
    ...
    'docs/reviews/evidence/g009-batch16-stage-a-production-browser.json',
    'docs/reviews/evidence/g009-batch16-stage-b-production-browser.json',
    REVIEW_PATH,
    EVIDENCE_PATH,
  ...
  assert.equal(isHistoricalReviewArtifact('docs/reviews/evidence/g009-batch15-stage-b-production-browser-fabricated.json'), true, 'Stage B production near-match remains protected history');
  assert.equal(isHistoricalReviewArtifact('docs/reviews/evidence/g009-batch16-stage-a-production-browser-fabricated.json'), true, 'DDD-01 production near-match remains protected history');
  assert.equal(isHistoricalReviewArtifact('docs/reviews/evidence/g009-batch16-stage-b-production-browser-fabricated.json'), true, 'DDD-01 Stage B production near-match remains protected history');
