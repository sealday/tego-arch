...
const contracts = new Map([
  ...
  ['content/quality-attributes/qa-03-performance-latency-throughput-capacity.mdx', {
    urls: ['/cases/apache-kafka-consumer-groups', '/cases/cloudflare-durable-objects-workerd', '/img/illustrations/qa-03-load-saturation-boundaries.png', '/quality-attributes', '/quality-attributes/qa-00', '/quality-attributes/qa-00', '/quality-attributes/qa-02', '/quality-attributes/qa-02', '/quality-attributes/qa-04', '/quality-attributes/qa-10', '/styles/sty-09', 'https://sre.google/sre-book/handling-overload/', 'https://sre.google/sre-book/handling-overload/', 'https://sre.google/sre-book/monitoring-distributed-systems/', 'https://sre.google/sre-book/monitoring-distributed-systems/', 'https://www.sei.cmu.edu/library/quality-attributes/'],
