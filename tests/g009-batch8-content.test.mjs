...
export const EXPECTED_CURRENT_PROJECTION = Object.freeze({completed_topics: 62, content_documents: 105, governed_sources: 544});
...
test('governs STY-07 sources, reciprocal relations, and current STY-10 next-topic projection', async () => {
  ...
  for (const [id, published, topicStatus] of [[TOPIC_ID, true, 'complete'], [NEXT_TOPIC, true, 'complete'], ['STY-10', false, 'pending']]) {
