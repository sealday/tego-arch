...
export const EXPECTED_CURRENT_PROJECTION = Object.freeze({completed_topics: 64, content_documents: 107, governed_sources: 560});
...
test('governs STY-07 sources, reciprocal relations, and current STY-11 next-topic projection', async () => {
  ...
  for (const [id, published, topicStatus] of [[TOPIC_ID, true, 'complete'], [NEXT_TOPIC, true, 'complete'], ['STY-10', true, 'complete'], ['STY-11', true, 'complete'], ['STY-12', false, 'pending']]) {
