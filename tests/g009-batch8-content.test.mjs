...
export const EXPECTED_CURRENT_PROJECTION = Object.freeze({completed_topics: 83, content_documents: 126, governed_sources: 599});
...
test('governs STY-07 sources, reciprocal relations, and current STY-11 next-topic projection', async () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      'content/styles/sty-13-space-based-architecture.mdx',
    ],
    'only the five canonical reciprocal documents make STY-08 actionable',
  );
